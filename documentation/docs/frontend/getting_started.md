...
- `constants`
  ...
  - `constants/interfaces.ts`: Frontend schemas
...
:::note
If you do not own a developer or Azure account, you can request the original environment variable configurations and have your device added to the researcher's developer account.
:::

1. Create a `.env` file to store the environment variables:
    ...
    View your IP address for `EXPO_PUBLIC_API_URL`:
